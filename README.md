...
| Ссылка на GitHub | [https://github.com/IvanZarutsky/kontrol_git_rpo]|
...
Fetch - загружает изменения из github, но не применяет их к локальным файла
Pull - загружает и сразу применяет


## Конфликт и его решение

Конфликт возникает в двух случаях(По крайне мере мы прошли):

1. На обоих ветках файл был изменён
2. Файл на сервер и файл локально были изменены

Решения:

1. Принять изменения одно из файла
